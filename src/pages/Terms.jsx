...
export default function Terms() {
  return (
    <LegalLayout title="Terms & Conditions" lastUpdated="January 2025">
      ...
      <p>All products sold by Bio Pulse are intended strictly for laboratory and research purposes. Products are NOT FOR HUMAN CONSUMPTION. By purchasing from Bio Pulse, you confirm that products will be used exclusively for legitimate research and laboratory applications.</p>
